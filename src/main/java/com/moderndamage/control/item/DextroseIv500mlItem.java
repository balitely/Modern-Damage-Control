...
public class DextroseIv500mlItem extends Item {
    public DextroseIv500mlItem(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        if (entity instanceof Player player && !level.isClientSide) {
            player.addEffect(new MobEffectInstance(ModEffects.IV_FLUID.get(), 6 * 20, 0));
