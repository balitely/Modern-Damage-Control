...
public class NarRapidResponseKitItem extends Item {
    public NarRapidResponseKitItem(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        if (entity instanceof Player player && !level.isClientSide) {
            ...
            player.addEffect(new MobEffectInstance(ModEffects.PAIN_SUPPRESSION.get(), 120 * 20, 0));
