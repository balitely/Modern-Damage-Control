...
public class SalineIv500mlItem extends Item {
    public SalineIv500mlItem(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        if (entity instanceof Player player && !level.isClientSide) {
            player.addEffect(new MobEffectInstance(ModEffects.IV_FLUID.get(), 15 * 20, 0));
            stack.shrink(1);
