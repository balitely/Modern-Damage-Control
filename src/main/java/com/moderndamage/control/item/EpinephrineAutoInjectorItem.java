...
public class EpinephrineAutoInjectorItem extends Item {
    public EpinephrineAutoInjectorItem(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        if (entity instanceof Player player && !level.isClientSide) {
            player.addEffect(new MobEffectInstance(ModEffects.EPINEPHRINE_BOOST.get(), 60 * 20, 0));
            stack.shrink(1);
