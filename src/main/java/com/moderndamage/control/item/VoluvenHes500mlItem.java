...
public class VoluvenHes500mlItem extends Item {
    public VoluvenHes500mlItem(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        if (entity instanceof Player player && !level.isClientSide) {
            player.addEffect(new MobEffectInstance(ModEffects.IV_FLUID.get(), 12 * 20, 1));
            stack.shrink(1);
