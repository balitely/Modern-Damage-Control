...
public class OctaplasPlasma200mlItem extends Item {
    public OctaplasPlasma200mlItem(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        if (entity instanceof Player player && !level.isClientSide) {
            player.addEffect(new MobEffectInstance(ModEffects.IV_FLUID.get(), 11 * 20, 1));
